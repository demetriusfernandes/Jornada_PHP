...
<div class="container justify-content-center w-50 mt-4">
        <?php
                $nome = $_GET['nome'];
                $usuario = $_GET['usuario'];
                echo "O nome da pessoa é <span class='fw-bold text-danger'>$nome</span> e seu usuário é <span class='fw-bold text-primary'>$usuario</span><br>";
